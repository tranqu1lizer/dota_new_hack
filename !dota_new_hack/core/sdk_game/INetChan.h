...
public:
	...
	virtual EDOTAGCMsg GetEMsg( ) const = 0;
	...
	inline EDOTAGCMsg GetMessageID( ) {
		return *reinterpret_cast<EDOTAGCMsg*>( reinterpret_cast<std::uintptr_t>( this ) + 0x78 );
	}
};
...
public:
	...
	virtual void* unk3( const char* ) = 0;
	virtual NetMessageInfo_t* GetNetMessageInfo2( NetMessageHandle_t* ) = 0;
