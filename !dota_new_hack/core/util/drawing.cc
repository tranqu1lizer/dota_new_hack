...
void drawing::DrawRect( const ImVec2& topLeft, const ImVec2& size, const ImVec4& color, float thickness ) {
...
void drawing::DrawRectFilled( const ImVec2& topLeft, const ImVec2& size, const ImVec4& color ) {
	auto DrawList = ImGui::GetForegroundDrawList( );
...
float drawing::DrawTextForeground( ImFont* pFont, const std::string& text, const ImVec2& pos, float size, const ImVec4& color, bool center, bool outline )
{
